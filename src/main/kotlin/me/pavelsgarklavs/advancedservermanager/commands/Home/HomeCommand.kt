...
class HomeCommand(plugin: AdvancedServerManager): CommandExecutor, Utils(plugin) {
    ...
    override fun onCommand(sender: CommandSender, command: Command, label: String, args: Array<out String>): Boolean {
        ...
        if (args.isEmpty()) {
            ifPermissible(sender, "advancedservermanager.home", {
                ...
                val homes: FileConfiguration = YamlConfiguration.loadConfiguration(File(plugin.dataFolder, "homes.yml"))
